...
function MainProduct({imgsrc, name, price, rate, avgRate, description, id}) {
  return (
      <div className="mx-auto w-3/4 min-w-[280px] max-w-[420px] bg-medium-purple-400 hover:bg-medium-purple-500 dark:bg-medium-purple-700 dark:hover:bg-medium-purple-600 dark:text-white rounded-md py-4 lg:pt-10 px-6 hover:scale-95  transition">
        <Link to={`/products/${id}`}>
