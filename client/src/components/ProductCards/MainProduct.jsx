...
function MainProduct({imgsrc, name, price, rate, avgRate, description, id}) {
  return (
      <div className="w-11/12 min-w-[280px] max-w-[420px] bg-medium-purple-400 hover:bg-medium-purple-500 dark:bg-medium-purple-700 dark:hover:bg-medium-purple-600 dark:text-white rounded-md py-4 lg:py-10 px-6 hover:scale-95 transition">
        <Link to={`/product/${id}`}>
